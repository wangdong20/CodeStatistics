...
public class CodeAnalyzer {
    ...
    public static final CodeReport generateReport(String path, String fileName) throws IOException {
        ...
        while((str = bufferedReader.readLine()) != null) {
            ...
            if(!str.equals("")) {
                ...
                } else if (str.startsWith("*") && isMutipleLineOfComments) {
                    lineOfComments++;
                }  else {
                    lineOfCode++;
                }
    ...
    public static final List<CodeReport> generateReport(String path) throws IOException {
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            if (files[i].isFile() && (fileName.endsWith(Controller.JAVA_CODE_FILE_SUFFIX) ||
                    fileName.endsWith(Controller.C_CODE_FILE_SUFFIX))) {
